...
const RegisterPage = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-[calc(100vh-4.1rem)] bg-gradient-to-br from-boulder-dark via-boulder-mid to-boulder-dark text-foreground overflow-hidden">
      <div className="w-full max-w-md bg-boulder-mid/70 backdrop-blur-md shadow-2xl rounded-2xl p-8 border border-boulder-gold animate-fadeIn">
        ...
        <p className="text-center text-gray-400 mb-8 font-body">
          Every climb begins with a single push.
        </p>

        <form onSubmit={onRegister} noValidate className="space-y-5 font-body">
          <div>
            <label
              htmlFor="email"
